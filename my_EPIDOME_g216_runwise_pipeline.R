...
pathF = "cutadapted_g216"
pathR = "cutadapted_g216"
...
# Filtering  #should include  truncLen=c(278,262), truncLen=c(393,593), minLen=190, 
out <- filterAndTrim(fwd=file.path(pathF, fastqFs), filt=file.path(filtpathF, fastqFs),
                     rev=file.path(pathR, fastqRs), filt.rev=file.path(filtpathR, fastqRs),
                       maxEE=10, truncQ=2, maxN=0, rm.phix=TRUE, minLen=185,
...
saveRDS(seqtab, "g216_seqtab_from_dada2.rds")
write.csv2(seqtab, "g216_seqtab_from_dada2.csv")
#14*263-->14*44
seqtab.nochim <- removeBimeraDenovo(seqtab, method="consensus", multithread=TRUE)
saveRDS(seqtab.nochim, "g216_seqtab_nochim.rds")
write.csv2(seqtab.nochim, "g216_seqtab_nochim.csv")

#g216_seqtab_from_dada2.rds
save.image("g216_seqtab_image.RData")
...
write.csv2(track, "g216_track.csv")
