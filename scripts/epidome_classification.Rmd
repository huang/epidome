...
epi01_table = read.table("https://raw.githubusercontent.com/ssi-dk/epidome/master/example_data/190920_run1_G216_classified_995p.csv",sep = ";",header=TRUE,row.names=1)
epi02_table = read.table("https://raw.githubusercontent.com/ssi-dk/epidome/master/example_data/190920_run1_yycH_classified_995p.csv",sep = ";",header=TRUE,row.names=1)
...
```{r}
epi01_mock_table = read.table("https://raw.githubusercontent.com/ssi-dk/epidome/master/example_data/190920_run2_g216_test.csv",sep = ";",header=TRUE,row.names=1)
epi02_mock_table = read.table("https://raw.githubusercontent.com/ssi-dk/epidome/master/example_data/190920_run2_yycH_test.csv",sep = ";",header=TRUE,row.names=1)
epi01_clinical_table = read.table("https://raw.githubusercontent.com/ssi-dk/epidome/master/example_data/190920_run1_G216_classified_995p.csv",sep = ";",header=TRUE,row.names=1)
epi02_clinical_table = read.table("https://raw.githubusercontent.com/ssi-dk/epidome/master/example_data/190920_run1_yycH_classified_995p.csv",sep = ";",header=TRUE,row.names=1)
